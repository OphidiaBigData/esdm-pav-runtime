...
static const char *const oph_server_conf_params[] = { SERVER_CONF_RABBITMQ_USERNAME, SERVER_CONF_RABBITMQ_PASSWORD, SERVER_CONF_TASK_QUEUE_NAME, SERVER_CONF_MASTER_HOSTNAME,
	...
	SERVER_CONF_DATABASE_PATH, SERVER_CONF_MAX_WORKERS, SERVER_CONF_MAX_NCORES, SERVER_CONF_CANCELLATION_MULTIPLICATION_FACTOR, SERVER_CONF_MAX_CANCELLATION_STRUCT_SIZE, SERVER_CONF_WORKER_THREAD_NUMBER
};
