...
#define SERVER_CONF_KILLER                              "KILLER"
// WORKER CONF
...
static const char *const oph_server_conf_params[] = { SERVER_CONF_RABBITMQ_USERNAME, SERVER_CONF_RABBITMQ_PASSWORD, SERVER_CONF_TASK_QUEUE_NAME, SERVER_CONF_MASTER_HOSTNAME,
	SERVER_CONF_MASTER_PORT, SERVER_CONF_WORKER_HOSTNAME, SERVER_CONF_WORKER_PORT, SERVER_CONF_UPDATE_QUEUE_NAME, SERVER_CONF_DBMANAGER_QUEUE_NAME, SERVER_CONF_DELETE_QUEUE_NAME,
	SERVER_CONF_DATABASE_PATH, SERVER_CONF_KILLER, SERVER_CONF_MAX_WORKERS, SERVER_CONF_MAX_NCORES, SERVER_CONF_CANCELLATION_MULTIPLICATION_FACTOR,
    SERVER_CONF_MAX_CANCELLATION_STRUCT_SIZE, SERVER_CONF_WORKER_THREAD_NUMBER, SERVER_CONF_LAUNCHER, SERVER_CONF_FRAMEWORK_PATH
};
