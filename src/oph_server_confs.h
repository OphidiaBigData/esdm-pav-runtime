...
#define SERVER_CONF_MAX_WORKERS                         "MAX_WORKERS"
#define SERVER_CONF_DATABASE_PATH                       "DATABASE_PATH"
#define SERVER_CONF_SCHEDULER                           "SCHEDULER"
// WORKER CONF
#define SERVER_CONF_WORKER_HOSTNAME                     "WORKER_HOSTNAME"
#define SERVER_CONF_WORKER_PORT                         "WORKER_PORT"
#define SERVER_CONF_UPDATE_QUEUE_NAME                   "UPDATE_QUEUE_NAME"
#define SERVER_CONF_DBMANAGER_QUEUE_NAME                "DBMANAGER_QUEUE_NAME"
#define SERVER_CONF_DELETE_QUEUE_NAME                   "DELETE_QUEUE_NAME"
#define SERVER_CONF_MAX_NCORES                          "MAX_NCORES"
#define SERVER_CONF_CANCELLATION_MULTIPLICATION_FACTOR  "CANCELLATION_MULTIPLICATION_FACTOR"
#define SERVER_CONF_MAX_CANCELLATION_STRUCT_SIZE        "MAX_CANCELLATION_STRUCT_SIZE"
#define SERVER_CONF_WORKER_THREAD_NUMBER                "WORKER_THREAD_NUMBER"
#define SERVER_CONF_LAUNCHER                            "LAUNCHER"
...
static const char *const oph_server_conf_params[] = { SERVER_CONF_RABBITMQ_USERNAME, SERVER_CONF_RABBITMQ_PASSWORD, SERVER_CONF_TASK_QUEUE_NAME, SERVER_CONF_MASTER_HOSTNAME,
	SERVER_CONF_MASTER_PORT, SERVER_CONF_MAX_WORKERS, SERVER_CONF_DATABASE_PATH, SERVER_CONF_SCHEDULER, SERVER_CONF_WORKER_HOSTNAME,
	SERVER_CONF_WORKER_PORT, SERVER_CONF_UPDATE_QUEUE_NAME, SERVER_CONF_DBMANAGER_QUEUE_NAME, SERVER_CONF_DELETE_QUEUE_NAME,
	SERVER_CONF_MAX_NCORES, SERVER_CONF_CANCELLATION_MULTIPLICATION_FACTOR, SERVER_CONF_MAX_CANCELLATION_STRUCT_SIZE,
	SERVER_CONF_WORKER_THREAD_NUMBER, SERVER_CONF_LAUNCHER, SERVER_CONF_FRAMEWORK_PATH
};
